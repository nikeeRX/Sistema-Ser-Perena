    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background">
      <Card className="w-full max-w-lg mx-4 shadow-lg bg-card border-border">
        <CardContent className="pt-8 pb-8 text-center">
          ...
          <h2 className="text-xl font-semibold text-foreground/80 mb-4">Página não encontrada</h2>
          ...
          <Button onClick={() => setLocation("/")} className="bg-primary text-primary-foreground hover:bg-primary/90 px-6 py-2.5">
